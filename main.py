...
def compare_iterative_tran_algorithm(N_values,iterations=5,epsilon=0.1,num_trials=50): # 比较trans算法中纯mT和迭代m*T以及经典算法的区别
    ...
    for N in N_values:
        ...
        for _ in range(num_trials):
            ...
            iterative_tran_solution, iterative_tran_satisfied,_,_ = iterative_annealing_tran_solution(N,planted_solution,constraints,iterations)
...
if __name__ == '__main__':
    N_values = list(range(4, 7))
    compare_iterative_tran_algorithm(N_values,iterations=5,epsilon=0.1,num_trials=10)
